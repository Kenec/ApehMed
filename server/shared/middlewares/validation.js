...
export function validateSymptoms(req, res, next) {
  const errors = {};
...
export function validateSickness(req, res, next) {
  const errors = {};
  
  if ((!req.body.sickness) || (req.body.sickness.trim() == "")) {
    errors.sickness = "sickness field is required";
  }
